...
use super::{
    ...
    permission, queued_hint, recommendations, setup,
};
...
pub fn render(frame: &mut Frame, app: &mut App) {
    ...
    // hint, a permanently reserved activity row, an optional queued-prompt
    // row directly above the input, and input at the bottom. Cap chat at
    // `pane_height - rec - permission - input - activity - hints - queue`
