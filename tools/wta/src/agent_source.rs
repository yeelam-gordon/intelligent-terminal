...
mod tests {
    ...
    fn wsl_cwd_normalizes_terminal_path_forms() {
        assert_eq!(
            crate::protocol::acp::cwd_format::to_wsl_format(
                "Ubuntu",
        ...
        assert_eq!(
            crate::protocol::acp::cwd_format::to_wsl_format(
                "Ubuntu",
                Path::new(r"\\wsl.localhost\Ubuntu\home\me"),
            )
            .as_deref(),
        ...
        assert_eq!(
            crate::protocol::acp::cwd_format::to_wsl_format(
                "Ubuntu",
                Path::new("//wsl.localhost/Ubuntu/home/me"),
            )
            .as_deref(),
            Some(Path::new("/home/me"))
        );
        assert_eq!(
            crate::protocol::acp::cwd_format::to_wsl_format(
                "Ubuntu",
                Path::new(r"C:\src\project"),
            )
            .as_deref(),
            Some(Path::new("/mnt/c/src/project"))
        );
        assert_eq!(
            crate::protocol::acp::cwd_format::to_wsl_format("Ubuntu", Path::new("~")),
            None
        );
        assert_eq!(
            crate::protocol::acp::cwd_format::to_wsl_format(
                "Ubuntu",
                Path::new(r"\\wsl$\Debian\home\me"),
            ),
            None
        );
    }
    ...
    fn wsl_cwd_normalizes_unc_roots_with_trailing_separator() {
        for cwd in [
            ...
            assert_eq!(
                crate::protocol::acp::cwd_format::to_wsl_format("Ubuntu", Path::new(cwd))
                    .as_deref(),
                Some(Path::new("/"))
            );
        }
